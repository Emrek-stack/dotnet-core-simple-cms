...
using SimpleCms.Core.Extensions;
...
namespace SimpleCms.PostContext.Core.Domain
{
    public class Post : EntityBase
    {
        ...
        public Post ChangeTitle(string title)
        {
            ...
            {
                throw new SimpleCms.Core.ValidationException("Title could not be null or empty.");
            }
        ...
        public Post ChangeExcerpt(string excerpt)
        {
            ...
            {
                throw new SimpleCms.Core.ValidationException("Excerpt could not be null or empty.");
            }
